...
for _, ud in pairs(UnitDefs) do
	if ud.customParams and ud.customParams.tactical_ai_defs_belongs_to then
...
local AllArrays={
	longRangeSwarmieeArray = longRangeSwarmieeArray,
	medRangeSwarmieeArray = medRangeSwarmieeArray,
	lowRangeSwarmieeArray = lowRangeSwarmieeArray,
	skirmRangeRiotIdleFleeArray = skirmRangeRiotIdleFleeArray,
	longRangeRiotIdleFleeArray = longRangeRiotIdleFleeArray,
	medRangeRiotIdleFleeArray = medRangeRiotIdleFleeArray,
	shortRangeRiotIdleFleeArray = shortRangeRiotIdleFleeArray,
	longRangeRaiderIdleFleeArray = longRangeRaiderIdleFleeArray,
	medRangeRaiderIdleFleeArray = medRangeRaiderIdleFleeArray,
	shortRangeRaiderIdleFleeArray = shortRangeRaiderIdleFleeArray,
	veryShortRangeRaiderIdleFleeArray = veryShortRangeRaiderIdleFleeArray,
	torpedoIdleFleeArray = torpedoIdleFleeArray,
	veryShortRangeSkirmieeArray = veryShortRangeSkirmieeArray,
	shortRangeSkirmieeArray = shortRangeSkirmieeArray,
	shortToRiotRangeSkirmieeArray = shortToRiotRangeSkirmieeArray,
	riotRangeSkirmieeArray = riotRangeSkirmieeArray,
	lowMedRangeSkirmieeArray = lowMedRangeSkirmieeArray,
	medRangeSkirmieeArray = medRangeSkirmieeArray,
	longRangeSkirmieeArray = longRangeSkirmieeArray,
	artyRangeSkirmieeArray = artyRangeSkirmieeArray,
	slasherSkirmieeArray = slasherSkirmieeArray,
	personalShieldUnits = personalShieldUnits,
	personalShieldUnitsWithSafetyMargin = personalShieldUnitsWithSafetyMargin,
	veryShortRangeExplodables = veryShortRangeExplodables,
	shortRangeExplodables = shortRangeExplodables,
	diverExplodables = diverExplodables,
	medRangeExplodables = medRangeExplodables,
	explodableFull = explodableFull,
	diverSkirmieeArray = diverSkirmieeArray,
	skirmableAir = skirmableAir,
	brawler = brawler,
	fleeables = fleeables,
	subfleeables = subfleeables,
	shortRangeDiveArray = shortRangeDiveArray,
}
local AllGlobals=Union(
	{
		allGround = allGround,
		allMobileGround = allMobileGround,
		armedLand = armedLand,
