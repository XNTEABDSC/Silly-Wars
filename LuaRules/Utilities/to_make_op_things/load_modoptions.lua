...
if not Spring.Utilities.to_make_op_things.load_modoptions then
    local to_make_op_things=Spring.Utilities.to_make_op_things

    to_make_op_things.to_make_op_things_include("tweak_fns")
    local wacky_utils=Spring.Utilities.wacky_utils
    local AddFnToUnitDefsTweakFns=to_make_op_things.AddFnToUnitDefsTweakFns
    local unit_defs_tweak_fns=to_make_op_things.unit_defs_tweak_fns
