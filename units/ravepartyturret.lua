...
for i=1,6 do
    ...
    --do_copy_tweak_unit(make_copy_tweak(spamed_list[i][1],udname .. spamed_list[i][1],set_dummy_unit))
    --spamed_list[i][1]=newname
end

local ud=utils.GetUnitLua("raveparty")
ud.name="Turret Disco Rave Party"
...
utils_op.MakeSetSillyBuildMorphSimple("raveparty",udname)

ud.customParams.translations=[=[{
    en={
        name = "Turret Disco Rave Party",
        description="Turret Projector",
