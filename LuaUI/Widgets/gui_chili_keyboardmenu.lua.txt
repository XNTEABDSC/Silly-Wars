...
-- config
include("keysym.lua")
local factory_commands,econ_commands, defense_commands, special_commands = include("Configs/integral_menu_commands_processed.lua")
local _, _, overrides = include("Configs/integral_menu_config.lua")
