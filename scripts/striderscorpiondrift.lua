...
local angle_step_to=Spring.Utilities.wacky_utils.angle_step_to
--------------------------------------------------------------------------------
-- constants
--------------------------------------------------------------------------------
-- Signal definitions
...
function script.AimWeapon(num, heading, pitch)
	...
	elseif num ~= 1 then
		...
		Turn(pivot, y_axis, wpn_heading+wpnangle[num], math.rad(120))
		...
		while true do
			...
			if abs(heading_dif)<math.rad(10)  then
				break
			end
			Sleep(33)
		end
